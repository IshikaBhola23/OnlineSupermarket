    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phone.png" style="width:27px;" alt="img">+91 7905992891<br>
                <img src="images/mail.png" style="width:29px;" alt="img">ishikabhola23@gmail.com<br>shreyaansubhankar123@gmail.com<br>reetagarwal11@gmail.com
            </b>
        </p>
        </div>
      </div>
...
<div class="modal fade getwalletmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header custom-bg text-white text-center">
      ...
      <div class="modal-body">
      <div class="container text-center">
		  <h5><%if(user!=null){ %><%=user.getUserPhone() %><%} %></h5>
         </div> 
          <form action="LoginServlet" method="post">
    ...
    <div class="form-group ">
      <label for="Want to add money">Want to add money?</label>
      <input type="text" class="form-control" name="addedmoney" placeholder="Enter Money to be added" required>
    </div>
  </div>
  ...
  <div class="container text-center">
       ...
       <input type="submit" class="btn custom-bg text-light" value="Add">
       <button type="button" class="btn custom-bg text-light ml-5" data-dismiss="modal">Close</button>
